...
func initialize(parent_machine: StateMachine):
	...
	parent.player.anim_tree.set("parameters/Grounded/conditions/grounded", false)
	parent.player.anim_tree.set("parameters/Grounded/conditions/aerial", true)
	parent.player.anim_tree.set("parameters/Aerial/conditions/grounded", false)
	parent.player.anim_tree.set("parameters/Aerial/conditions/aerial", true)
